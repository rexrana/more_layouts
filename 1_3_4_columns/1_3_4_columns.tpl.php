...
/**
 * @file
 * Template for a complex 1-3-4 column layout.
 *
 * This template is useful for a home page or landing page layout, with
 * a one-column content area. The regions are similar to Bartik, except
 * with no sidebars in the content area. The template includes responsive 
 ...
 */
?>
<div class="layout--1-3-4-columns <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  <div id="skip-link">
